<template>
  <div class="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
      <div class="lg:col-span-2 bg-white rounded-lg shadow-sm p-6 transition duration-300 ease-in-out hover:shadow-md" style="height: 300px;"> <!-- Altura fija -->
        ...
        <Bar v-if="chartData" :data="chartData" :options="chartOptions" class="h-full" /> <!-- Clase h-full para que ocupe toda la altura -->
      </div>
